...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default="output/new_modloss/", help='output save path')
    parser.add_argument('--ckpt_name', type=str, default="/mnt/HDD2/lamle/PromptIR/train_ckpt/best.ckpt", help='checkpoint save path')
    ...
    net  = PromptIRModel.load_from_checkpoint(ckpt_path, strict=False).to(device)
    net.eval()
